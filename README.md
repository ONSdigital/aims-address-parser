...
This repository wraps the parser module extracted from the [AIMS-API](https://github.com/ONSdigital/aims-api) in a Spring Boot App. An address string input will be transformed into a tokenised output following the rules set out in the AIMS API.
